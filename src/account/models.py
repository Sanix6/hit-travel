...
from .services import add_lead_on_creation, add_tourist_on_user_creation
...
class User(AbstractUser):
    ...
    issued_by = models.CharField(
        _("Орган выдачи"), null=True, blank=True, max_length=100
    )
    ...
    passport_id = models.CharField(
        _("ID паспорт"), max_length=36, null=True, blank=True, unique=True
    )
...
class RequestTour(models.Model):
    ...
    inn = models.CharField(_("ИНН"), max_length=100, null=True, blank=True)
    passport_id = models.CharField(
        _("ID пасспорта"), max_length=255, null=True, blank=True
    )
    date_of_issue = models.DateField(_("Дата выдачи"), null=True, blank=True)
    issued_by = models.CharField(
        _("Орган выдачи"), null=True, blank=True, max_length=100
    ...
    paid = models.FloatField(
        _("Всего оплачено"), blank=True, null=True, help_text="в Сомах"
    )
    ...
    pdf = models.FileField(
        _("Прикрепить PDF"), upload_to="agreements", null=True, blank=True
    )
    created_at = models.DateTimeField(
        _("Дата создания"), auto_now_add=True, null=True, blank=True
    )
    surcharge = models.CharField(
        _("Доплата"), max_length=255, default=10, null=True, blank=True
    )
...
class Payments(models.Model):
    ...
    bank_name = models.CharField(
        _("Название банка"), null=True, blank=True, max_length=400
    )
...
class ManualRequests(models.Model):
    user = models.ForeignKey(
        User, verbose_name=_("Клиент"), on_delete=models.SET_NULL, null=True, blank=True
    )
...
class RequestHotel(models.Model):
    ...
    paid = models.FloatField(
        _("Всего оплачено"), blank=True, null=True, help_text="в Сомах", default=0
    )
    currency = models.ForeignKey(
        Currency, null=True, blank=True, on_delete=models.CASCADE
    )
    ...
    mealrussian = models.CharField(
        _("Питание (на русском)"), max_length=255, blank=True, null=True
    )
...
class Traveler(models.Model):
    ...
    passport_id = models.CharField(
        _("Серия и номер з/п"), max_length=255, null=True, blank=True
    )
    # date_of_issue = models.DateField(_("Дата выдачи"), null=True, blank=True)
    issued_by = models.CharField(
        _("Орган, выдачи з/п"), null=True, blank=True, max_length=100
    )
    # validity = models.DateField(_("Срок действия"), null=True, blank=True)
    # city = models.CharField(_("Город"), max_length=255, null=True, blank=True)
    # country = models.CharField(_("Страна"), max_length=255, null=True, blank=True)
