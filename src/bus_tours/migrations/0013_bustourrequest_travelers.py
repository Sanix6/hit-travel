        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "Новая"), (2, "ЧВ работе"), (3, "Подтверждена")],
                        default=1,
                        verbose_name="Статус",
                    ),
                ),
                ...
                (
                    "passport_id",
                    models.CharField(max_length=255, verbose_name="ID пасспорта"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="bustour_travelers",
                        to="bus_tours.bustourrequest",
                    ),
                ),
            ],
            options={
