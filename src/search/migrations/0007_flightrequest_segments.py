    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_class', models.CharField(choices=[('e', 'Эконом класс'), ('b', 'Бизнес класс'), ('f', 'Первый класс')], verbose_name='Класс')),
                ('main', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='segments', to='search.flightrequest')),
            ],
            options={
