...
from .models import Countries, Favorites
...
class AddRemoveTourFavoriteView(views.APIView):
    ...
    def post(self, request, tourid):
        ...
        try:
            ...
            return Response(
                {"response": False, "message": "Ошибка базы данных", "details": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )

        except Exception as e:
            return Response(
                {"response": False, "message": "Произошла ошибка", "details": str(e)},
